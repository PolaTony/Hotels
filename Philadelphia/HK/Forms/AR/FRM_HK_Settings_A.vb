...
Public Class FRM_HK_Settings_A
...
#Region " Save                                                                          "
    Private Function fIsSaveNeeded() As Boolean
        ...
        ElseIf Tab_Main.Tabs("Tab_CleaningPoints").Selected Then
            For Each vRow In Grd_CleaningPoints.Rows
                ...
                End If
            Next
        ElseIf Tab_Main.Tabs("Tab_PublicCleaning").Selected Then
            For Each vRow In Grd_PublicCleaning.Rows
                If vRow.Cells("DML").Value = "I" Or vRow.Cells("DML").Value = "U" Then
                    Return True
                End If
            Next
        ElseIf Tab_Main.Tabs("Tab_PublicCleaningPoints").Selected Then
            For Each vRow In Grd_PublicCleaningPoints.Rows
                If vRow.Cells("DML").Value = "I" Or vRow.Cells("DML").Value = "U" Then
                    Return True
                End If
            Next
                ...
                Select Case Tab_Main.SelectedTab.Key
                    ...
                    Case "Tab_CleaningPoints"
                        ...
                        Else
                            Return False
                        End If
                    Case "Tab_PublicCleaning"
                        If fValidatePublicCleaningTypes() Then
                            sSavePublicCleaningTypes()
                        Else
                            Return False
                        End If
                    Case "Tab_PublicCleaningPoints"
                        If fValidatePublicCleaningPoints() Then
                            sSavePublicCleaningPoints()
                        Else
                            Return False
                        End If
                End Select
    ...
    Private Sub sSetFlagsUpdate()
        ...
        ElseIf Tab_Main.Tabs("Tab_PublicCleaning").Selected Then
            sQueryPublicCleaningTypes()
        ElseIf Tab_Main.Tabs("Tab_PublicCleaningPoints").Selected Then
            sQueryPublicCleaningPoints()
        End If
    End Sub
            ...
            If Not Grd_RoomTypes.ActiveRow Is Nothing Then
                If Grd_RoomTypes.ActiveRow.Cells("DML").Value = "N" Or Grd_RoomTypes.ActiveRow.Cells("DML").Value = "U" Then
                    If vcFrmlevel.vParentFrm.sForwardMessage("39", Me) = MsgBoxResult.Yes Then
                        vSqlString = " Delete From Rooms_Types " &
        ...
        ElseIf Tab_Main.Tabs("Tab_CleaningTypes").Selected Then
            If Not Grd_CleaningTypes.ActiveRow Is Nothing Then
                If Grd_CleaningTypes.ActiveRow.Cells("DML").Value = "N" Or Grd_CleaningTypes.ActiveRow.Cells("DML").Value = "U" Then
                    If vcFrmlevel.vParentFrm.sForwardMessage("39", Me) = MsgBoxResult.Yes Then
                        vSqlString = " Delete From HK_Cleaning_Types " &
        ...
        ElseIf Tab_Main.Tabs("Tab_CleaningPoints").Selected Then
            If Not Grd_CleaningPoints.ActiveRow Is Nothing Then
                If Grd_CleaningPoints.ActiveRow.Cells("DML").Value = "N" Or Grd_CleaningPoints.ActiveRow.Cells("DML").Value = "U" Then
                    If vcFrmlevel.vParentFrm.sForwardMessage("39", Me) = MsgBoxResult.Yes Then
                        vSqlString = " Delete From HK_Rooms_Cleaning_Points " &
            ...
            End If
        ElseIf Tab_Main.Tabs("Tab_PublicCleaning").Selected Then
            If Not Grd_PublicCleaning.ActiveRow Is Nothing Then
                If Grd_PublicCleaning.ActiveRow.Cells("DML").Value = "N" Or Grd_PublicCleaning.ActiveRow.Cells("DML").Value = "U" Then
                    If vcFrmlevel.vParentFrm.sForwardMessage("39", Me) = MsgBoxResult.Yes Then
                        vSqlString = " Delete From HK_Public_Types " &
                                     " Where Code = " & Grd_PublicCleaning.ActiveRow.Cells("Code").Value &
                                     " And    Company_Code = " & vCompanyCode

                        If cControls.fSendData(vSqlString, Me.Name) > 0 Then
                            vcFrmlevel.vParentFrm.sForwardMessage("38", Me)
                            Grd_PublicCleaning.ActiveRow.Delete(False)
                        End If
                    End If
                Else
                    Grd_PublicCleaning.ActiveRow.Delete(False)
            ...
            End If
        ElseIf Tab_Main.Tabs("Tab_PublicCleaningPoints").Selected Then
            If Not Grd_PublicCleaningPoints.ActiveRow Is Nothing Then
                If Grd_PublicCleaningPoints.ActiveRow.Cells("DML").Value = "N" Or Grd_PublicCleaningPoints.ActiveRow.Cells("DML").Value = "U" Then
                    If vcFrmlevel.vParentFrm.sForwardMessage("39", Me) = MsgBoxResult.Yes Then
                        vSqlString = " Delete From HK_Public_Cleaning_Points " &
                                     " Where Code = " & Grd_PublicCleaningPoints.ActiveRow.Cells("Code").Value &
                                     " And    Company_Code = " & vCompanyCode

                        If cControls.fSendData(vSqlString, Me.Name) > 0 Then
                            vcFrmlevel.vParentFrm.sForwardMessage("38", Me)
                            Grd_PublicCleaningPoints.ActiveRow.Delete(False)
                        End If
                    End If
                Else
                    Grd_PublicCleaningPoints.ActiveRow.Delete(False)
...
#Region " Query                                                                         "
    Private Sub sQueryRoomTypes()
        Try
            ...
            vsqlCommand.CommandText = " Select Code, DescA, Remarks From Rooms_Types Where 1 = 1 And Company_Code = " & vCompanyCode
    ...
    Private Sub sSaveRoomTypes()
        ...
        For Each vRow In Grd_RoomTypes.Rows
            ...
            If vRow.Cells("DML").Value = "I" Then
                ...
                vSqlString = " Select IsNull(Max(Code), 0) + 1 From Rooms_Types " &
                             " Where  Company_Code  = " & vCompanyCode

                vGetCode = cControls.fReturnValue(vSqlString, Me.Name) + vCounter

                vSqlString = " Insert Into Rooms_Types (       Code,           Company_Code,                   DescA,                                Remarks             )" &
...
#Region " Query                                                                         "
    Private Sub sQueryCleaningTypes()
        Try
            Dim vRowCounter As Integer
            Dim vsqlCommand As New SqlCommand
            vsqlCommand.CommandText = " Select Code, DescA, Remarks From HK_Cleaning_Types Where 1 = 1 And Company_Code = " & vCompanyCode
    ...
    Private Sub sSaveCleaningTypes()
        ...
        For Each vRow In Grd_CleaningTypes.Rows
            ...
            If vRow.Cells("DML").Value = "I" Then
                ...
                vSqlString = " Select IsNull(Max(Code), 0) + 1 From HK_Cleaning_Types " &
                             " Where  Company_Code  = " & vCompanyCode

                vGetCode = cControls.fReturnValue(vSqlString, Me.Name) + vCounter

                vSqlString = " Insert Into HK_Cleaning_Types (       Code,           Company_Code,                      DescA,                              Remarks )" &
            ...
            ElseIf vRow.Cells("DML").Value = "U" Then
                ...
                vSqlString = " Update HK_Cleaning_Types  " &
                             "                        " &
                             " Set    DescA        = '" & vRow.Cells("DescA").Text & "', " &
                             "        Remarks      = '" & vRow.Cells("Remarks").Text & "' " &
                             "                        " &
...
#Region " Query                                                                         "
    Private Sub sQueryPublicCleaningTypes()
        Try
            Dim vRowCounter As Integer
            Dim vsqlCommand As New SqlCommand
            vsqlCommand.CommandText = " Select Code, DescA, Remarks From HK_Public_Types Where 1 = 1 And Company_Code = " & vCompanyCode

            vsqlCommand.Connection = cControls.vSqlConn
            cControls.vSqlConn.Open()
            Dim vSqlReader As SqlDataReader = vsqlCommand.ExecuteReader
            vRowCounter = 0
            DTS_PublicCleaningTypes.Rows.Clear()
            Do While vSqlReader.Read
                DTS_PublicCleaningTypes.Rows.SetCount(vRowCounter + 1)

                'Code
                If IsDBNull(vSqlReader("Code")) = False Then
                    DTS_PublicCleaningTypes.Rows(vRowCounter)("Code") = vSqlReader("Code")
                End If

                'DescA
                If IsDBNull(vSqlReader("DescA")) = False Then
                    DTS_PublicCleaningTypes.Rows(vRowCounter)("Item") = vSqlReader("DescA")
                End If

                'Remarks
                If IsDBNull(vSqlReader("Remarks")) = False Then
                    DTS_PublicCleaningTypes.Rows(vRowCounter)("Remarks") = vSqlReader("Remarks")
                End If

                DTS_PublicCleaningTypes.Rows(vRowCounter)("DML") = "N"
                vRowCounter += 1
            Loop
            cControls.vSqlConn.Close()
            vSqlReader.Close()
...
#Region " Save                                                                          "
    Private Function fValidatePublicCleaningTypes() As Boolean
        Dim vRow As UltraGridRow
        For Each vRow In Grd_PublicCleaning.Rows
            If vRow.Cells("Item").Text = "" Then
                vcFrmlevel.vParentFrm.sForwardMessage("180", Me)
        ...
        Return True
    End Function
    Private Sub sSavePublicCleaningTypes()
        ...
        Grd_PublicCleaning.UpdateData()

        For Each vRow In Grd_PublicCleaning.Rows

            If vRow.Cells("DML").Value = "I" Then

                vSqlString = " Select IsNull(Max(Code), 0) + 1 From HK_Public_Types " &
                             " Where  Company_Code  = " & vCompanyCode

                vGetCode = cControls.fReturnValue(vSqlString, Me.Name) + vCounter

                vSqlString = " Insert Into HK_Public_Types (       Code,           Company_Code,                   DescA,                                Remarks             )" &
                             " Values                            ( " & vGetCode & ", " & vCompanyCode & ", '" & vRow.Cells("Item").Text & "', '" & vRow.Cells("Remarks").Text & "' )"
            ...
            ElseIf vRow.Cells("DML").Value = "U" Then
                ...
                vSqlString = " Update HK_Public_Types  " &
                             "                               " &
                             " Set    DescA        =        '" & vRow.Cells("Item").Text & "', " &
                             "        Remarks      =        '" & vRow.Cells("Remarks").Text & "' " &
                             "                               " &
...
#Region " Navigation                                                                    "
    Private Sub GRD_PublicCleaningTypes_CellChange(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles Grd_PublicCleaning.CellChange
        If sender.ActiveRow.Cells("DML").Value = "NI" Then
            sender.ActiveRow.Cells("DML").Value = "I"
        ElseIf sender.ActiveRow.Cells("DML").Value = "N" Then
            sender.ActiveRow.Cells("DML").Value = "U"
        End If
    End Sub
    Private Sub GRD_PublicCleaningTypes_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Grd_PublicCleaning.KeyUp
        If e.KeyData = Keys.Delete And e.Control Then
            sDelete()
        End If
    End Sub
    Private Sub GRD_PublicCleaningTypes_ClickCellButton(sender As Object, e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles Grd_PublicCleaning.ClickCellButton
        If sender.ActiveRow.Cells("Delete").Activated Then
            sDelete()
        End If
    End Sub
...
#Region " Query                                                                         "
    Private Sub sQueryCleaningPoints()
        Try
            Dim vRowCounter As Integer
            Dim vsqlCommand As New SqlCommand
            vsqlCommand.CommandText = " Select Code, Room_Type, Cleaning_Type, Points From HK_Rooms_Cleaning_Points Where 1 = 1 And Company_Code = " & vCompanyCode
            ...
            Dim vRow As UltraGridRow
            For Each vRow In Grd_CleaningPoints.Rows
                vRow.Cells("Room_Type").Activation = Activation.NoEdit
                vRow.Cells("Cleaning_Type").Activation = Activation.NoEdit
            Next
    ...
    Private Sub sSaveCleaningPoints()
        ...
        For Each vRow In Grd_CleaningPoints.Rows
            ...
            If vRow.Cells("DML").Value = "I" Then
                ...
                vSqlString = " Select IsNull(Max(Code), 0) + 1 From HK_Rooms_Cleaning_Points " &
                             " Where  Company_Code  = " & vCompanyCode

                vGetCode = cControls.fReturnValue(vSqlString, Me.Name) + vCounter

                vSqlString = " Insert Into HK_Rooms_Cleaning_Points (       Code,           Company_Code,                     Room_Type,                             Cleaning_Type,                             Points            )" &
            ...
            ElseIf vRow.Cells("DML").Value = "U" Then
                ...
                vSqlString = " Update HK_Rooms_Cleaning_Points  " &
                             "                         " &
...
#Region " Public Cleaning Points "

#Region " DataBase                                                                      "

#Region " Query                                                                         "
    Private Sub sQueryPublicCleaningPoints()
        Try
            Dim vRowCounter As Integer
            Dim vsqlCommand As New SqlCommand
            vsqlCommand.CommandText = " Select Code, Public_Type, Cleaning_Type, Points From HK_Public_Cleaning_Points Where 1 = 1 And Company_Code = " & vCompanyCode

            vsqlCommand.Connection = cControls.vSqlConn
            cControls.vSqlConn.Open()
            Dim vSqlReader As SqlDataReader = vsqlCommand.ExecuteReader
            vRowCounter = 0
            DTS_PublicCleaningPoints.Rows.Clear()
            Do While vSqlReader.Read
                DTS_PublicCleaningPoints.Rows.SetCount(vRowCounter + 1)

                'Code
                If IsDBNull(vSqlReader("Code")) = False Then
                    DTS_PublicCleaningPoints.Rows(vRowCounter)("Code") = vSqlReader("Code")
                End If

                'Room_Type
                If IsDBNull(vSqlReader("Public_Type")) = False Then
                    DTS_PublicCleaningPoints.Rows(vRowCounter)("Public_Type") = vSqlReader("Public_Type")
                End If

                'Cleaning_Type
                If IsDBNull(vSqlReader("Cleaning_Type")) = False Then
                    DTS_PublicCleaningPoints.Rows(vRowCounter)("Cleaning_Type") = vSqlReader("Cleaning_Type")
                End If

                'Points
                If IsDBNull(vSqlReader("Points")) = False Then
                    DTS_PublicCleaningPoints.Rows(vRowCounter)("Points") = vSqlReader("Points")
                End If

                DTS_PublicCleaningPoints.Rows(vRowCounter)("DML") = "N"
                vRowCounter += 1
            Loop
            cControls.vSqlConn.Close()
            vSqlReader.Close()
    ...
    Private Sub sLoad_PublicCleaningTypes()
        Try
            Dim vsqlCommand As New SqlCommand
            vsqlCommand.CommandText =
            " Select Code, Desc" & vLang & " From HK_Public_Types " &
            " Where 1 = 1 And Company_Code = " & vCompanyCode

            vsqlCommand.Connection = cControls.vSqlConn
            cControls.vSqlConn.Open()
            Dim vSqlReader As SqlDataReader = vsqlCommand.ExecuteReader
            Txt_PublicTypes.Items.Clear()

            Do While vSqlReader.Read
                Txt_PublicTypes.Items.Add(vSqlReader("Code"), vSqlReader("DescA"))
            Loop
            cControls.vSqlConn.Close()
            Txt_PublicTypes.SelectedIndex = -1
...
#Region " Save                                                                          "
    Private Function fValidatePublicCleaningPoints() As Boolean
        Grd_PublicCleaningPoints.UpdateData()

        Dim vRow As UltraGridRow
        For Each vRow In Grd_PublicCleaningPoints.Rows
            If vRow.Cells("Public_Type").Text = "" Then
                vcFrmlevel.vParentFrm.sForwardMessage("180", Me)
                vRow.Cells("Public_Type").Selected = True
                Return False
            End If
            If vRow.Cells("Cleaning_Type").Text = "" Then
                vcFrmlevel.vParentFrm.sForwardMessage("184", Me)
        ...
        Return True
    End Function
    Private Sub sSavePublicCleaningPoints()
        ...
        For Each vRow In Grd_PublicCleaningPoints.Rows
            ...
            If vRow.Cells("DML").Value = "I" Then
                ...
                vSqlString = " Select IsNull(Max(Code), 0) + 1 From HK_Public_Cleaning_Points " &
                             " Where  Company_Code  = " & vCompanyCode

                vGetCode = cControls.fReturnValue(vSqlString, Me.Name) + vCounter

                vSqlString = " Insert Into HK_Public_Cleaning_Points (       Code,           Company_Code,                     Public_Type,                             Cleaning_Type,                             Points            )" &
                             " Values                             ( " & vGetCode & ", " & vCompanyCode & ", " & vRow.Cells("Public_Type").Value & ", " & vRow.Cells("Cleaning_Type").Value & ", " & vRow.Cells("Points").Text & " )"
            ...
            ElseIf vRow.Cells("DML").Value = "U" Then
                ...
                vSqlString = " Update HK_Public_Cleaning_Points  " &
                             "                                " &
                             " Set    Public_Type     =       " & vRow.Cells("Public_Type").Value & ", " &
                             "        Cleaning_Type   =       " & vRow.Cells("Cleaning_Type").Value & ", " &
                             "        Points          =       " & vRow.Cells("Points").Text & " " &
                             "                                " &
                             " Where  Code            =       " & vRow.Cells("Code").Value &
...
#Region " Navigation                                                                    "
    Private Sub GRD_PublicCleaningPoints_CellChange(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles Grd_PublicCleaningPoints.CellChange
        If sender.ActiveRow.Cells("DML").Value = "NI" Then
            sender.ActiveRow.Cells("DML").Value = "I"
        ElseIf sender.ActiveRow.Cells("DML").Value = "N" Then
            sender.ActiveRow.Cells("DML").Value = "U"
        End If
    End Sub
    Private Sub GRD_PublicCleaningPoints_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Grd_PublicCleaningPoints.KeyUp
        If e.KeyData = Keys.Delete And e.Control Then
            sDelete()
        End If
    End Sub
    Private Sub GRD_PublicCleaningPoints_ClickCellButton(sender As Object, e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles Grd_PublicCleaningPoints.ClickCellButton
        If sender.ActiveRow.Cells("Delete").Activated Then
            sDelete()
        End If
    End Sub
    Private Sub Grd_PublicCleaningPoints_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Grd_PublicCleaningPoints.KeyPress
        If Grd_PublicCleaningPoints.ActiveCell IsNot Nothing AndAlso Grd_PublicCleaningPoints.ActiveCell.Column.Key = "Points" Then
            ' Allow digits, control characters (like Backspace)
            If Not Char.IsControl(e.KeyChar) AndAlso Not Char.IsDigit(e.KeyChar) Then
                e.Handled = True ' Cancel the keypress
            End If
