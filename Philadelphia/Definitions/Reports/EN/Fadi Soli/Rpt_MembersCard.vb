...
Public Class Rpt_MembersCard
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Retex.Rpt_MembersCard.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_MembersCard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_MembersCard = New Rpt_MembersCard()
        rpt.Site = Me.Site
        Return rpt
    End Function
