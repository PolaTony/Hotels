...
Public Class Rep_ItemsDetails_L
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Retex.Rep_ItemsDetails_L.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_ItemsDetails_L
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_ItemsDetails_L = New Rep_ItemsDetails_L()
        rpt.Site = Me.Site
        Return rpt
    End Function
