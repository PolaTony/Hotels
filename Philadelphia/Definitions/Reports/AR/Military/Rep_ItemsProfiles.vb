...
Public Class Rep_ItemsProfiles
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Retex.Rep_ItemsProfiles.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_ItemsProfiles
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_ItemsProfiles = New Rep_ItemsProfiles()
        rpt.Site = Me.Site
        Return rpt
    End Function
