...
Public Class Frm_Companies_AllInvoices
    ...
    Private Sub sQuerySummaryMain(Optional ByVal pCode As String = "", Optional ByVal pDesc As String = "")
        Try
            ...
            " Select  Sales_Invoices_Companies.Code,                                " & vbCrLf &
            "         Sales_Invoices_Companies.DescA as PI_DescA,                   " & vbCrLf &
            "         Employees.DescA as Emp_Desc,                           " & vbCrLf &
            "         Customers_POS.DescA as Provider_Desc,                 " & vbCrLf &
            "         TDate                                                  " & vbCrLf &
            " From Sales_Invoices_Companies Inner Join Employees                   " & vbCrLf &
            " On   Sales_Invoices_Companies.Emp_Code = Employees.Code                " & vbCrLf &
            " Inner Join Customers_POS " & vbCrLf &
            " On Sales_Invoices_Companies.Provider_Code = Customers_POS.Code    " & vbCrLf &
            " Where 1 = 1                                                    " & vbCrLf &
            vCodeFilter1 & vbCrLf &
            vDescFilter1 & vbCrLf &
    ...
    Private Sub sQuerySummaryDetails(ByVal pRow As UltraDataRow, ByVal pChildBand As UltraDataBand)
        Try
            ...
            Dim vRowCounter As Integer
            vsqlCommand.CommandText =
            " Select Sales_Invoices_Companies_Details.Ser,                   " &
            "        Items.UserCode,                                         " &
            "        Items.DescA as Item_Desc,                               " &
            "        Sales_Invoices_Companies_Details.Quantity,              " &
            "        Sales_Invoices_Companies_Details.Price,                 " &
            "        Sales_Invoices_Companies_Details.Deduction,             " &
            "        Sales_Invoices_Companies_Details.LCost,                 " &
            "        Sales_Invoices_Companies_Details.Str_Code,              " &
            "        Stores.DescA                                            " &
            "        From  Sales_Invoices_Companies_Details Inner Join  Items              " &
            "        On    Sales_Invoices_Companies_Details.Item_Code = Items.Code         " &
            "        Left  Join Stores                                       " &
            "        On Stores.Code = Sales_Invoices_Companies_Details.Str_Code            " &
            " Where  Sales_Invoices_Companies_Details.SI_Code = '" & pRow("Code") & "' " &
            " Order  By Ser       "
