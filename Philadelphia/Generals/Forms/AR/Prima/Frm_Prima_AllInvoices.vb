...
Public Class Frm_Prima_AllInvoices
    ...
    Private Sub sQuerySummaryMain(Optional ByVal pCode As String = "", Optional ByVal pDesc As String = "")
        Try
            ...
            " Select  Sales_Invoices.Code,                                    " & vbCrLf & _
            "         Sales_Invoices.DescA as PI_DescA,                      " & vbCrLf & _
            "         Employees.DescA as Emp_Desc,                           " & vbCrLf & _
            "         Customers.DescA as Provider_Desc,                      " & vbCrLf & _
            "         Stores.DescA as Store_Desc,                            " & vbCrLf & _
            "         TDate                                                  " & vbCrLf & _
            " From  Sales_Invoices  Inner Join Sales_Invoice_Details         " & vbCrLf & _
            " On Sales_Invoices.Code = Sales_Invoice_Details.SI_Code         " & vbCrLf & _
            " INNER Join Customers                                           " & vbCrLf & _
            " On Customers.Code =  Sales_Invoices.Provider_Code              " & vbCrLf & _
            " INNER Join Stores                                              " & vbCrLf & _
            " On  Stores.Code = Sales_Invoice_Details.Str_Code               " & vbCrLf & _
            " INNER Join Branches                                            " & vbCrLf & _
            " On Branches.Code = Stores.Company_Code                          " & vbCrLf & _
            " INNER Join Employees                                           " & vbCrLf & _
            " ON Branches.Code = Employees.Branch                            " & vbCrLf & _
            " Where 1 = 1                                                    " & vbCrLf & _
            " And Employees.Code = '" & vUsrCode & "'                        " & vbCrLf & _
