...
Public Class Frm_LovRegions
    ...
    Private Sub Btn_Ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Ok.Click
        Try
            ...
            ElseIf Grd_Main.Selected.Rows.Count > 1 Then
                ...
                For Each vRow As UltraGridRow In Grd_Main.Selected.Rows
                    vSelectedSortedList_1.Add(vRow.Cells("DescA").Text, vRow.Cells("DescA").Text)
                Next
    ...
    Private Sub Txt_FndByCode_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_FndByDesc.ValueChanged
        sLoadMainNodes("", Trim(Txt_FndByDesc.Text))
    End Sub
End Class